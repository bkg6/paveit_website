      ...
      <main className="flex-1">
        <section className="py-20">
          <div className="container max-w-4xl">
            <h1 className="font-source-serif text-4xl font-bold mb-8">Privacy Policy</h1>
            <div className="prose max-w-none">
              <p className="text-sm text-muted-foreground mb-8">Last updated on 24-02-2025</p>
              
              <div className="space-y-6">
                <h2 className="text-2xl font-semibold">Introduction</h2>
                <p>This Privacy Policy describes how AWECHEMIST TECHNOLOGIES PVT LTD and its affiliates (collectively "AWECHEMIST TECHNOLOGIES PVT LTD, we, our, us") collect, use, share, protect or otherwise process your information/personal data through our website https://www.paveit.io/ (hereinafter referred to as Platform).</p>
                ...
                <h2 className="text-2xl font-semibold mt-8">Collection</h2>
                ...
                <p>If you receive an email, a call from a person/association claiming to be AWECHEMIST TECHNOLOGIES PVT LTD seeking any personal data like debit/credit card PIN, net-banking or mobile banking password, we request you to never provide such information. If you have already revealed such information, report it immediately to an appropriate law enforcement agency.</p>
                ...
                <h2 className="text-2xl font-semibold mt-8">Sharing</h2>
                ...
                <h2 className="text-2xl font-semibold mt-8">Security Precautions</h2>
                ...
                <h2 className="text-2xl font-semibold mt-8">Data Deletion and Retention</h2>
                ...
                <h2 className="text-2xl font-semibold mt-8">Grievance Officer</h2>
                <p>Bharath</p>
                <p>Designation: CEO</p>
                <p>AWECHEMIST TECHNOLOGIES PVT LTD</p>
                <p>Contact us: bharath@paveit.io</p>
                <p>Phone: +91 8884444636</p>
